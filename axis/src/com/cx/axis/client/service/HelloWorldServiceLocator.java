...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.cx.axis.client.service.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/demo/services/HelloWorld";
    ...
    public com.cx.axis.client.service.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cx.axis.client.service.HelloWorldSoapBindingStub _stub = new com.cx.axis.client.service.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cx.axis.client.service.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cx.axis.client.service.HelloWorldSoapBindingStub _stub = new com.cx.axis.client.service.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8080/demo/services/HelloWorld", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8080/demo/services/HelloWorld", "HelloWorld"));
        }
